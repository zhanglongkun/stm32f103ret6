...
/**
  ...
  * Description:  Timer1或8的PWM配置
  * Parameter:    TIMx：TIM1 或者 TIM8
                  arr：重载值
                  psc: 分频值
  * Return:       void
...
/**
  ...
  * Description:  Timer6或7的定时配置
  * Parameter:    TIMx：TIM6 或者 TIM7
                  arr：重载值
                  psc分频值
  * Return:       void
  * Others:       add by zlk, 2017-06-02
